/**
  License: MIT License. Copyright 2025 Mitsumine Suzu
*/
...
#define BOARD_NAME    "esp32c3board"
#define MDNS_HOSTNAME "esp32c3board"
#define WIFI_AP_SSID  "ESP32C3-AP"
#define WIFI_AP_PSK   "12345678"

constexpr int PIN_LED = 2;
constexpr int pin_gpio_count = 10;
const int pin_gpio[pin_gpio_count] = { 0, 1, 3, 4, 5, 6, 7, 8, 9, 10 };
